...
class AuthControllerTest {
        ...
        void loginSetsSecureHttpOnlyCookieWithSameSite() {
                ...
                ResponseEntity<?> response = controller.login(
                                new LoginRequest("user@example.com", "verifier", null, null, null), request,
                                responseServlet);
        ...
        void loginFailsWhenVerifierDoesNotMatchAfterTrimmingWhitespace() {
                ...
                ResponseEntity<?> response = controller.login(
                                new LoginRequest("user@example.com", "   wrong   ", null, null, null), request,
        ...
        void resendVerificationReturnsAccepted() {
                ...
                ResponseEntity<?> response = controller
                                .resendVerification(new ResendVerificationRequest("user@example.com"));
