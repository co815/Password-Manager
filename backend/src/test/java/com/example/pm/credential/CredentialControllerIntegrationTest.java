...
class CredentialControllerIntegrationTest {
        ...
        void setUpMocks() {
                ...
                when(credentialRepository.findByUserIdAndServiceIgnoreCase(anyString(), anyString()))
        ...
        void authenticatedUserCanCreateCredentialWhenSupplyingCsrfToken() throws Exception {
                ...
                String registerCsrfToken = Optional
                                .ofNullable(registerCsrfResult.getResponse().getHeader("X-XSRF-TOKEN"))
                ...
                var loginRequest = new AuthDtos.LoginRequest(registerRequest.email(), registerRequest.verifier(), null,
                                null, null);
                ...
                assertThat(credentialStore.values())
                                .anyMatch(cred -> "GitHub".equals(cred.getService())
                                                && "alice@example.com".equals(resolveEmailForUser(cred.getUserId())));
        }
